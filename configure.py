...
LIBS = [
    ...
    },
    {
        ...
        "objects": [
            ...
            NonMatching("f_pc/f_pc_leaf.cpp"),
            NonMatching("f_pc/f_pc_line.cpp"),
            NonMatching("f_pc/f_pc_load.cpp"),
            NonMatching("f_pc/f_pc_manager.cpp"),
            NonMatching("f_pc/f_pc_method.cpp"),
            ...
            NonMatching("f_pc/f_pc_method_iter.cpp"),
